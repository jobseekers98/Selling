<%@ Page Title="" Language="C#" MasterPageFile="~/Store/MasterPageDesigner.master" AutoEventWireup="true" CodeFile="UploadDairy.aspx.cs" Inherits="Designer_upload_Design_KidsDesign" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="Server">
    ...
    <p>
        <strong style="font-family: 'Tempus Sans ITC'; color: #CC6600; font-size: large;">To upload a Dairy Items fill the following fields:<br />
            <br />
            <table class="auto-style1">
                ...
                <asp:Button ID="btnUpload" runat="server" Text="Upload" OnClick="btnUpload_Click" />
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <asp:Label ID="lblMessage" runat="server" ForeColor="#66FF66"></asp:Label>
                        </strong></td>
                </tr>
            </table>
        </strong>
