...
public partial class Designer_upload_Design_KidsDesign : System.Web.UI.Page
{
    DataClassesDataContext db = new DataClassesDataContext();
    protected void Page_Load(object sender, EventArgs e)
    {
        TextBox1.Text = "Dairy & Eggs";
    ...
    protected void btnUpload_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            string _ProcName = "usp_UploadKidsDesign";
            ...
            if (index > 0)
            {
                lblMessage.Text = "Design Uploaded Successfull";
            }
            else
            {
