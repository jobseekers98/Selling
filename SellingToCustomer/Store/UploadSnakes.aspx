<%@ Page Title="" Language="C#" MasterPageFile="~/Store/MasterPageDesigner.master" AutoEventWireup="true" CodeFile="UploadSnakes.aspx.cs" Inherits="Designer_upload_Design_LadiesSuit" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="Server">
    ...
    <p>
        <strong style="font-family: 'Tempus Sans ITC'; color: #CC6600; font-size: large;">To upload a Snacks Items fill the following fields:<br />
            <br />
            <table class="auto-style1">
                ...
                <tr>
                    <td class="auto-style1">Store Login ID</td>
