...
public partial class Designer_upload_Design_LadiesSaree : System.Web.UI.Page
{
    DataClassesDataContext db = new DataClassesDataContext();
    protected void Page_Load(object sender, EventArgs e)
    {
        TextBox1.Text = "Packaged Food";    
    }
    protected void btnUpload_Click(object sender, EventArgs e)
    {
        string fpath = "~\\DesignsUploaded\\" + FileUpload1.FileName;
        ...
        try
        {
            string _ProcName = "usp_UploadSareeDesign";
