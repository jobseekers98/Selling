...
public class UserADO
{
    ...
    private SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings["ITServiceDeskConnectionString"].ConnectionString);
    ...
    private void OpenConnection()
        {
            if (_connection == null)
            {
                _connection = new SqlConnection(ConfigurationManager.ConnectionStrings["ITServiceDeskConnectionString"].ConnectionString);
            }
